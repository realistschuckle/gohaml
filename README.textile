...
Go has the nifty @goinstall@ experimental package manager. You can try this, but I won't guarantee its success.

pre. goinstall "github.com/realistschuckle/gohaml/lib"
goinstall "github.com/realistschuckle/gohaml/exe"
