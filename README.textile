...
* Tag nesting
* Simple lookup for tag content (@%p= someKeyInScope@)
* Simple lookup for attribute names (@%p{keyForAttrName => "value"}@)
* Simple lookup for attribute values (@%p{:attr => keyForAttrValue}@)
